...
def read_jetkvm_client_files(src_dir: str) -> dict:
    """
...
"""
This script dynamically recreates the "jetkvm_client" directory tree
from embedded static file contents, and then copies its own contents to
the clipboard.
Usage:
    python create_jetkvm_client_dynamic.py
"""
...
def main():
    parser = argparse.ArgumentParser(description="Generate a dynamic script for jetkvm_client.")
    parser.add_argument("--src-only", action="store_true", help="Only process the src folder inside jetkvm_client.")
    args = parser.parse_args()

    # Determine the directory to process
    base_dir = "../../jetkvm_client"
